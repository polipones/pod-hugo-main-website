...
Available here: [Operating rules Pod-O-Lab](https://s3.pod.cvut.cz/common/provozni_rady/pod_o_lab/operating_rules_pod_o_lab_en.pdf). If there are differences, the Czech version of the rules is the one that counts.
